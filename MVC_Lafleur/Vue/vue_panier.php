...
{  //si l'action n'est pas ajout, suppression ou refresh alors erreur = vrai 
   ...
   if($action=='ajout')
   {
		...
		header("Location:index.php?do=listeProduits");
   }
                ...
                <form method="post" action="index.php?do=panier&action=refresh">
                    ...
                    <table class="tabpanier" cellspacing="0">
                        ...
                        <?php
                            ...
                            {	//On compte le nombre de références dans le panier et on le stock dans une variable
                                ...
                                else
                                {
                                    for ($i=0 ;$i < $nbArticles ; $i++)
                                    {
										...
										echo "
                                             <td>
                                                 <a href='index.php?do=panier&action=suppression&pdt_ref=".rawurlencode($_SESSION['panier']['pdt_ref'][$i])."'><img src='Images/supprimer.png'/></a>
                                             </td>
                                        ";
                                        echo "</tr>";
                                    }
                            ...
                            if ($nbArticles > 0)
                            {
								echo"<form name='commande' action='index.php?do=traitementCommandes' method='POST'>";
                        ...
                        ?>
                <br/>
                <a class='panier' href="index.php?do=listeProduits">Retour à la liste des produits</a>
            </div>
