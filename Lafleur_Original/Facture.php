<?php
    ...
    mysql_select_db('LAFLEUR_BDD',$db);

	//On inclut la bibliothèque de fonctions FPDF
    require('fpdf.php');
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $req = mysql_query($req) or die("Impossible d'exécuter la requête");
            ...
            while ($commandes = mysql_fetch_array($req))
            {
